...
function showResult(){
  ...
  if(userScore <= 2) {
    ...
    icon.innerHTML = `<i class="fa-regular fa-face-frown col-y"></i>`;
  }
    ...
    icon.innerHTML = `<i class="fa-solid fa-thumbs-up col-y"></i>`;
  }
  else{
    sc = `<p> Congrats, You have scored `+ userScore + ` out of ` + NoOfQues + `</p>`;
    icon.innerHTML = `<i class="fas fa-crown col-y"></i>`;
  }
  score.innerHTML = sc;
  console.log(icon);
}
